...
- **Default:** aceite eletrônico autenticado pela Steam, com hash do texto e declaração literal. PDF gov.br é anexo opcional. Novas versões não exigem reassinatura. *Não é parecer jurídico.*
...
### D-31 — Categoria *Family Sharing* ausente (art. 16, I) **[DECIDIR]**
...
| 14 | Categoria *Family Sharing* ausente (D-31) | Alerta com evidência |
