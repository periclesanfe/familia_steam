...
- Integração Steam: nick e avatar, biblioteca de cada membro, biblioteca compartilhável da família, lista de desejos (importada e manual), cache de dados de loja (preço em BRL, categoria _Family Sharing_, conteúdo adulto, tipo).
...
| App mobile nativo                                             | Web responsiva, _mobile-first_, cobre                                               | —                                                              |
